          ...
          <div class="card-body">
            <form action="meus_dados.php" method="post">
              ...
              <div class="form-group">
                ...
                <input type="email" class="form-control" placeholder="Digite aqui..." name="email" id="email">
              </div>
              <div class="form-group">
                <label for="exampleInputEmail1">Telefone(WhatsApp):</label>
                <input type="text" class="form-control" placeholder="Digite aqui..." name="telefone" id="telefone">
              </div>
              <div class="form-group">
                <label for="exampleInputEmail1">Endereço:</label>
                <input type="text" class="form-control" placeholder="Digite aqui..." name="endereco" id="endereco">
              </div>
